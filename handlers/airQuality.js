...
async function getAirQuality(req, res) {
  ...
  const requestURL = `${baseURL}/v1/air-quality?latitude=${lat}&longitude=${lng}&current=european_aqi,pm10,pm2_5,carbon_monoxide,dust,uv_index,alder_pollen,birch_pollen,grass_pollen,mugwort_pollen,olive_pollen,ragweed_pollen&hourly=european_aqi,european_aqi_pm2_5,european_aqi_pm10&timeformat=unixtime&timezone=auto`;
